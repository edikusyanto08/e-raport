...
<!--                                                 <td><?php echo $data_r['thn_ajaran']; ?></td> -->
                                                ...
                                                <td>
                                                 <a href="?admin=detail_raport&nis=<?php echo $data_r['nis']; ?>" class="ubah"  title="" data-toggle="tooltip" data-original-title="Lihat Detail Raport Siswa <?php echo $data_r['nama_lengkap']?>">
                                                   ...
                                                   <a href="?admin=add_raport&nis=<?php echo $data_r['nis']; ?>" class="ubah"  title="" data-toggle="tooltip" data-original-title="Isi Raport Siswa <?php echo $data_r['nama_lengkap']?>">
