    ...
    <section class="content">
        ...
        //$jum = mysql_result($jumlah_record,0);
                        ...
                        $sql_mapel = mysqli_query($link, "SELECT tbl_mapel.kd_mapel,tbl_mapel.nama_mapel,tbl_mapel.nip,tbl_guru.nama_guru
                         from tbl_mapel INNER JOIN tbl_guru ON tbl_mapel.nip=tbl_guru.nip order by tbl_mapel.kd_mapel asc LIMIT $start, $per_hal;");
                                    ...
                                    <tbody>
                                        ...
                                        while ($data_mapel = mysqli_fetch_assoc($sql_mapel)) {
                                            ...
                                            <tr>
                                                ...
                                                <a href="#" data-href="index.php?admin=del_mapel&kd_mapel=<?php echo $data_mapel['kd_mapel']; ?>" data-toggle="modal" data-target="#confirm-delete">
                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="disabled"><a href="?admin=dt_mapel&page=<?php echo $page -1 ?>" aria-label="Previous"> <span aria-hidden="true">«</span></a></li>
                            </ul>
                            <?php 
                            for($x=1;$x<=$halaman;$x++)
                            {
                                ?>
                                <ul class="pagination">
                                    <li class="active"><a href="?admin=dt_mapel&page=<?php echo $x ?>"><?php echo $x ?><span class="sr-only">(current)</span></a></li>
                                </ul>
                                <?php
                            }
                            ?>
                            <ul class="pagination">
                                <li><a href="?admin=dt_mapel&page=<?php echo $page +1 ?>" aria-label="Next"> <span aria-hidden="true">»</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
