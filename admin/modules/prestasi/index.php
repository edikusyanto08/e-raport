...
<aside class="right-side">
    ...
    <section class="content">
        <h3 class="page-header"><i class="fa fa-trophy fa-fw fa-2x"></i> Halaman Prestasi Siswa
            <form class="navbar-form navbar-right" method="POST" action="?admin=cari_prestasi">
                
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-search"></i></span>
                    <input type="text" name="cari" class="tultip form-control" placeholder="Cari Siswa..." required="" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="Cari Berdasarkan NIS Siswa">
                </div>
            </form></h3>
                        ...
                        <p>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="#" data-toggle="modal" data-target="#Tambah"><i class="fa fa-user fa-lg"></i> Data Prestasi</a></li>
                                </ul>
                            </div>
                            <br/>
                        </p>
        ...
        //$jum = mysql_result($jumlah_record,0);
                        ...
                        $sql_prestasi = mysqli_query($link, "SELECT tbl_prestasi.nama_prestasi,tbl_prestasi.jenis,
                          ...
                          tbl_kelas ON tbl_prestasi.id_kelas=tbl_kelas.id_kelas order by tbl_prestasi.nis asc LIMIT $start, $per_hal;");
                                        ...
                                        while ($data_prestasi = mysqli_fetch_assoc($sql_prestasi)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <a href="#" class="edit-record" data-id="<?php echo $data_prestasi['nama_prestasi'];?>" title="" data-original-title="">
                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="disabled"><a href="?admin=prestasi&page=<?php echo $page -1 ?>" aria-label="Previous"> <span aria-hidden="true">«</span></a></li>
                            </ul>
                            <?php 
                            for($x=1;$x<=$halaman;$x++)
                            {
                                ?>
                                <ul class="pagination">
                                    <li class="active"><a href="?admin=prestasi&page=<?php echo $x ?>"><?php echo $x ?><span class="sr-only">(current)</span></a></li>
                                </ul>
                                <?php
                            }
                            ?>
                            <ul class="pagination">
                                <li><a href="?admin=prestasi&page=<?php echo $page +1 ?>" aria-label="Next"> <span aria-hidden="true">»</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
