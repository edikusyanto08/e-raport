...
--
-- Host: localhost
-- Generation Time: Apr 21, 2016 at 04:11 AM
...
ALTER TABLE `jadwal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_jadwal_tbl_guru` (`nip`),
  ADD KEY `FK_jadwal_tbl_mapel` (`kd_mapel`),
  ADD KEY `FK_jadwal_tbl_kelas` (`id_kelas`);
...
ALTER TABLE `presensi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK__tbl_siswa` (`nis`),
  ADD KEY `FK_presensi_tbl_kelas` (`id_kelas`);
...
ALTER TABLE `rapot`
  ...
  ADD KEY `fk_rapot_1_idx` (`nis`),
  ADD KEY `FK_rapot_tbl_kelas` (`id_kelas`),
  ADD KEY `fk_rapot_3` (`kd_mapel`);
...
ALTER TABLE `rekap_nilai`
  ...
  ADD KEY `FK__tbl_kelas` (`id_kelas`),
  ADD KEY `FK__tbl_mapel` (`kd_mapel`),
  ADD KEY `FK__tbl_mapel_2` (`nip`),
  ADD KEY `FK_rekap_nilai_tbl_siswa` (`nis`);
...
ALTER TABLE `tbl_mapel`
  ...
  ADD KEY `fk_tbl_mapel_1_idx` (`nip`);
...
ALTER TABLE `tbl_nilai`
  ...
  ADD KEY `FK_tbl_nilai_tbl_kelas` (`nis`),
  ADD KEY `FK_tbl_nilai_tbl_kelas_2` (`id_kelas`);
...
ALTER TABLE `tbl_prestasi`
  ...
  ADD KEY `fk_tbl_prestasi_2_idx` (`nis`),
  ADD KEY `FK_tbl_prestasi_tbl_kelas` (`id_kelas`);
...
ALTER TABLE `tbl_user`
  ...
  ADD KEY `FK_tbl_user_tbl_guru` (`nip`);
...
ALTER TABLE `tbl_walikelas`
  ...
  ADD KEY `nip` (`nip`),
  ADD KEY `FK_tbl_walikelas_tbl_kelas` (`id_kelas`);
...
--
ALTER TABLE `rekap_nilai`
  MODIFY `id_rekap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `tbl_user`
  ADD CONSTRAINT `FK_tbl_user_tbl_guru` FOREIGN KEY (`nip`) REFERENCES `tbl_guru` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;
